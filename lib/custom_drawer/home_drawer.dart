...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setDrawerListArray() {
      ...
      drawerList = <DrawerList>[
        ...
        DrawerList(
          index: DrawerIndex.REINA,
          labelName: 'Tiendas',
          icon: Icon(Icons.storefront_outlined),
        ),
        DrawerList(
          index: DrawerIndex.SETTINGS,
          labelName: 'Configuraciones',
          icon: Icon(Icons.settings_outlined),
        ),
        DrawerList(
          index: DrawerIndex.Acerca,
          labelName: 'Acerca de',
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Divider(
            height: 1,
            color: Color(0xFF313A44).withOpacity(0.6),
          ),
          Expanded(
                ...
                children: <Widget>[
                  ...
                  listData.isAssetsImage
                      ? Container(
                          width: 24,
                          height: 24,
                          child: Image.asset(listData.imageName, color: widget.screenIndex == listData.index ? colorDominante : Color(0xFF213333)),
                        )
                      : Icon(listData.icon?.icon, color: widget.screenIndex == listData.index ? colorDominante : Color(0xFF213333)),
                  const Padding(
                    padding: EdgeInsets.all(4.0),
                  ),
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: widget.screenIndex == listData.index ? colorDominante : Color(0xFF213333),
                    ),
                      ...
                      return Transform(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            height: 46,
                            decoration: BoxDecoration(
                              color: colorDominante.withOpacity(0.2),
